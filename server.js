    ...
    socket.on('buyBpItem', async (item, callback) => {
        ...
        try {
			...
			if (item === 'sazhik') {
                ...
                if (u.bpXP < 1500) return callback({ success: false, msg: "Не хватает XP (нужно 1500)!" }); // Поменяли на 1500
                u.bpXP -= 1500; // Поменяли на 1500
            ...
            if (item === 'matrix') {
                ...
                if (u.bpXP < 800) return callback({ success: false, msg: "Не хватает XP (нужно 800)!" }); // Поменяли на 800
                u.bpXP -= 800; // Поменяли на 800
